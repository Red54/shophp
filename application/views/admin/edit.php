		...
		<div class="panel panel-danger">
		  ...
		  <?=form_open('admin/edit/'.$id)?>
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" name="oldp" value="<?=set_value('oldp')?>" class="form-control">
                            </div>
                            <br />
                            <div class="input-group">
                            ...
                            <div class="text-center">
								<?php if (1 != $id): $status=set_value('status')?set_value('status'):$a['status'];?>
							<div class="radio">
							  <label>
							    <input type="radio" name="status" value="1"<?php if (1 == $status) echo ' checked';?>>
							    启用
							  </label>
							  <label>
							    <input type="radio" name="status" value="0"<?php if (0 == $status) echo ' checked';?>>
							    停用
							  </label>
							</div>
						<?php endif;?>
                                <input class="btn btn-warning" type="submit" value="编辑">
                            </div>
