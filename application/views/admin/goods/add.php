            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <?=validation_errors('<div class="alert alert-warning text-center" role="alert">', '</div>')?>
                        <?=form_open_multipart('admin/goods/add', array('onsubmit'=>'return copyContent()'))?>
                            ...
                            <div class="input-group">
                                ...
                                <input type="input" name="spec" value="<?=set_value('spec')?>" class="form-control">
                            </div>
                            <br />
                            <div class="input-group">
                            ...
                            <div class="input-group">
                                ...
                                <div contentEditable="true" id="introdiv" class="form-control"><?=set_value('intro', '', false)?></div>
                            </div>
                            <br />
                            <div class="input-group">
                                <span class="input-group-addon">品牌</span>
                                <input type="input" name="brand" value="<?=set_value('brand')?>" class="form-control">
                            </div>
                            <br />
                            <div class="input-group">
                                <span class="input-group-addon">市场价</span>
                                <input type="input" name="mprice" value="<?=set_value('mprice')?>" class="form-control">
                            </div>
                            <br />
                            <div class="input-group">
                                <span class="input-group-addon">商城价</span>
                                <input type="input" name="sprice" value="<?=set_value('sprice')?>" class="form-control">
                            </div>
                            <br />
                            <div class="input-group">
                                <span class="input-group-addon">库存量</span>
                                <input type="input" name="stocks" value="<?=set_value('stocks')?>" class="form-control">
                            </div>
                            <div class="text-center">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="status" value="1" <?php if (1==set_value('status', 1)) { echo 'checked'; }?>> 上架
                                    </label>
                                    <label>
                                        <input type="radio" name="status" value="0" <?php if (0==set_value('status', 1)) { echo 'checked'; }?>> 下架
                                    </label>
                                </div>
