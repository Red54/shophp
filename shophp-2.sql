...
CREATE TABLE `member` (
  ...
  `total` float NOT NULL DEFAULT '0' COMMENT '消费总额',
...
(2, 'someone', '9fcedc4dd6507a6d29709212abc87805f5ac2e02', 'some', 'fe05bcdcdc4928012781a5f1a2a77cbb5398e106', '09876543210', '987654321', 'some@one.uni', 'Matrix', '042054', 0, 0, '2016-07-01 23:22:03', 1);
...
--
ALTER TABLE `member`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '会员编号', AUTO_INCREMENT=3;
--
